      ...
      <View>
        <View>
          ...
          <Text style={styles.rules}>
            ...
            screen. Each dog can post a picture of them completing the challenge
            as well as like photos of other dogs doing the same. At the end of
            each week, a trophy will be given out to the house that has received
            the highest number of likes. We encourage you to tackle these
            challenges and post a picture of your completed look! Best of luck!{' '}
          </Text>
          <Text style={styles.textbold}>Continue Home to enter Pawgwartz!</Text>
